...
const personalPlanPeter = {
    ...
    showAgeAndLangs(obj) {
        let langsUpperCase = obj.skills.languages.join(' ').toUpperCase()
        return `Мне ${obj.age} и я владею языками: ${langsUpperCase}`
    }
};
...
function showProgrammingLangs({skills}) {
    ...
    for(let lang in skills.programmingLangs) {
        resultString += `Язык ${lang} изучен на ${skills.programmingLangs[lang]}\n`
    }
